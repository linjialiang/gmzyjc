...
const sidebar = [
  ...
  {
    text: '绪  论',
    link: `${path.main}gl00.1`,
    collapsed: true,
    items: [
      { text: '第一节 中医学理论体系的形成和发展', link: `${path.main}gl00.1-0.1.0.0.0` },
      {
        text: '第二节 中医学的唯物辩证观',
        link: `${path.main}gl00.1-0.2.0.0.0`,
        collapsed: true,
        items: [
          {
            text: '一、中医学的唯物观',
            link: `${path.main}gl00.1-0.2.1.0.0`,
            collapsed: true,
            items: [
      ...
      {
        text: '第三节 中医学的基本特点',
        link: `${path.main}gl00.1-0.3.0.0.0`,
        collapsed: true,
        items: [
          {
            text: '一、整体观',
            link: `${path.main}gl00.1-0.3.1.0.0`,
            collapsed: true,
            items: [
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: '第二节 五行学说',
        link: `${path.main}gl01-0.2.0.0.0`,
        collapsed: true,
        items: [
          {
            text: '一、五行学说的基本内容',
            link: `${path.main}gl01-0.2.1.0.0`,
            collapsed: true,
            items: [
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: '第一节 脏腑',
        link: `${path.main}gl02-0.1.0.0.0`,
        collapsed: true,
        items: [
          {
            text: '一、五脏六腑',
            link: `${path.main}gl02-0.1.1.0.0`,
            collapsed: true,
            items: [
      ...
      {
        text: '第二节 精、气、血、津液',
        link: `${path.main}gl02-0.2.0.0.0`,
        collapsed: true,
        items: [
          { text: '一、气', link: `${path.main}gl02-0.2.1.0.0` },
          {
            text: '二、血',
            link: `${path.main}gl02-0.2.2.0.0`,
            collapsed: true,
            items: [
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: '第九节 经络学说的临床应用',
        link: `${path.main}gl03-0.9.0.0.0`,
        collapsed: true,
        items: [
          {
            text: '一、指导临床辨证',
            link: `${path.main}gl03-0.9.1.0.0`,
            collapsed: true,
            items: [
  ...
  },
  {
    ...
    items: [
      {
        text: '第一节 病因',
        link: `${path.main}gl04-0.1.0.0.0`,
        collapsed: true,
        items: [
          {
            text: '一、六淫',
            link: `${path.main}gl04-0.1.1.0.0`,
            collapsed: true,
            items: [
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: '第三节  问诊',
        link: `${path.main}gl05-0.3.0.0.0`,
        collapsed: true,
        items: [
          { text: '一、问一般情况', link: `${path.main}gl05-0.3.1.0.0` },
          {
            text: '二、问现在病情',
            link: `${path.main}gl05-0.3.2.0.0`,
            collapsed: true,
            items: [
...

  {
    ...
    items: [
      {
        text: '第一节 防治原则',
        link: `${path.main}gl07-0.1.0.0.0`,
        collapsed: true,
        items: [
          { text: '一、预防原则', link: `${path.main}gl07-0.1.1.0.0` },
          {
            text: '二、治疗原则',
            link: `${path.main}gl07-0.1.2.0.0`,
            collapsed: true,
            items: [
      ...
      {
        text: '第二节  治疗方法',
        link: `${path.main}gl07-0.2.0.0.0`,
        collapsed: true,
        items: [
          {
            text: '一、内治法',
            link: `${path.main}gl07-0.2.1.0.0`,
            collapsed: true,
            items: [
  ...
  {
    text: '附：形体骨骼',
    link: `${path.main}gl11fu`,
    collapsed: true,
    items: [
      {
        text: '一、头面颈项部',
        link: `${path.main}gl11fu-0.0.1.0.0`,
        collapsed: true,
        items: [
      ...
      {
        text: '二、躯干部',
        link: `${path.main}gl11fu-0.0.2.0.0`,
        collapsed: true,
        items: [
      ...
      },
      {
        ...
        link: `${path.main}gl11fu-0.0.3.0.0`,
        collapsed: true,
        items: [
