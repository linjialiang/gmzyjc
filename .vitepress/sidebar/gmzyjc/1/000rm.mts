...
const sidebar = [
  ...
  { text: '第二章 天地自然', link: `${path.main}rm02` },
  {
    ...
    items: [
      ...
      { text: '3.2 人体元气', link: `${path.main}rm03-2` },
      { text: '3.3 人体地气', link: `${path.main}rm03-3` },
      { text: '3.4 人体天气', link: `${path.main}rm03-4` },
      { text: '3.5 精', link: `${path.main}rm03-5` },
      { text: '3.6 神', link: `${path.main}rm03-6` },
    ],
  },
