...
const sidebar = [
  ...
  { text: '第一章 绪论', link: `${path.main}zywx01` },
  {
    ...
    items: [
      ...
      { text: '四、以祝愿命名', link: `${path.main}zywx02-0.4.0.0.0` },
      { text: '五、以珍秘命名', link: `${path.main}zywx02-0.4.1` },
      { text: '六、以姓氏名字命名', link: `${path.main}zywx02-0.5.0.0.0` },
      { text: '七、以室名别号命名', link: `${path.main}zywx02-0.6.0.0.0` },
      { text: '八、以评议警世命名', link: `${path.main}zywx02-0.7.0.0.0` },
      { text: '九、以纪事命名', link: `${path.main}zywx02-0.8.0.0.0` },
      { text: '十、以形体命名', link: `${path.main}zywx02-0.9.0.0.0` },
    ],
  },
  {
    ...
    items: [
      ...
      { text: '四、提要', link: `${path.main}zywx03-0.4.0.0.0` },
      { text: '五、凡例', link: `${path.main}zywx03-0.5.0.0.0` },
      { text: '六、序跋', link: `${path.main}zywx03-0.6.0.0.0` },
      { text: '七、读法', link: `${path.main}zywx03-0.7.0.0.0` },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { text: '四、中医文献的分类', link: `${path.main}zywx05-0.4.0.0.0` },
    ],
  },
  {
    text: '第六章 小学与训诂',
  ...
  },
  {
    ...
    items: [
      ...
      { text: '四、辨章学术，考镜源流举例', link: `${path.main}zywx07-0.4.0.0.0` },
    ],
  },
