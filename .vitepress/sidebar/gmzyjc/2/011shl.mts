...
const sidebar = [
  { text: '编者与编者的话', link: `${path.main}shl00` },
  { text: '导言', link: `${path.main}daoyan` },
  { text: '绪论', link: `${path.main}shl0000` },
  {
    text: '伤寒论卷第一',
    collapsed: true,
    ...
    items: [
      {
        ...
        items: [
          ...
          { text: '脉法主病一览表', link: `${path.main}shl01.01-1.5.0.0.0` },
        ],
      },
      {
        text: '平脉法第二',
        ...
        items: [
          ...
          { text: '单元3', link: `${path.main}shl01.02-0.4.0.0.0` },
          { text: '单元4', link: `${path.main}shl01.02-0.5.0.0.0` },
          { text: '单元5', link: `${path.main}shl01.02-0.6.0.0.0` },
          { text: '单元6', link: `${path.main}shl01.02-0.7.0.0.0` },
          { text: '单元7', link: `${path.main}shl01.02-0.8.0.0.0` },
        ],
      },
    ],
  },
    ...
    items: [
      { text: '伤寒例第三', link: `${path.main}shl02.03-1.0.0.0.0` },
      {
        ...
        items: [
          ...
          { text: '单元3', link: `${path.main}shl02.04-0.4.0.0.0` },
        ],
      },
      {
        text: '辨太阳病脉证并治上第五',
    ...
    items: [
      {
        ...
        items: [
          ...
          { text: '58-70条', link: `${path.main}shl03.06-1.4.0.0.0` },
          { text: '71-75条', link: `${path.main}shl03.06-1.5.0.0.0` },
          { text: '76-81条', link: `${path.main}shl03.06-1.6.0.0.0` },
          { text: '82-95条', link: `${path.main}shl03.06-1.7.0.0.0` },
          { text: '96-109条', link: `${path.main}shl03.06-1.8.0.0.0` },
          { text: '110-119条', link: `${path.main}shl03.06-1.9.0.0.0` },
          { text: '120-123条', link: `${path.main}shl03.06-1.10.0.0.0` },
          { text: '124-127条', link: `${path.main}shl03.06-1.11.0.0.0` },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        items: [
          ...
          { text: '146-167条', link: `${path.main}shl04.07-1.4.0.0.0` },
          { text: '168-178条', link: `${path.main}shl04.07-1.5.0.0.0` },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        items: [
          ...
          { text: '199-200条', link: `${path.main}shl05.08-1.3.1.0.0` },
          { text: '201-203条', link: `${path.main}shl05.08-1.3.2.0.0` },
          { text: '204-206条', link: `${path.main}shl05.08-1.3.3.0.0` },
          { text: '207-218条', link: `${path.main}shl05.08-1.3.4.0.0` },
          { text: '219-230条', link: `${path.main}shl05.08-1.3.5.0.0` },
          { text: '231-237条', link: `${path.main}shl05.08-1.4.0.0.0` },
          { text: '238-242条', link: `${path.main}shl05.08-1.5.0.0.0` },
          { text: '243-247条', link: `${path.main}shl05.08-1.6.0.0.0` },
          { text: '248-256条', link: `${path.main}shl05.08-1.7.0.0.0` },
          { text: '257-262条', link: `${path.main}shl05.08-1.8.0.0.0` },
        ],
      },
      {
        text: '辨少阳病脉证并治第九',
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '301-325条', link: `${path.main}shl06.11-0.4.0.0.0` },
        ],
      },
      {
        text: '辨厥阴病脉证并治第十二',
  ...
  },
  {
    ...
    items: [
      ...
      { text: '辨不可发汗病脉证并治第十五', link: `${path.main}shl07.15` },
      { text: '辨可发汗病脉证并治第十六', link: `${path.main}shl07.16` },
    ],
  },
  {
    text: '伤寒论卷第八',
