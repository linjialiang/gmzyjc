...
export default defineConfig({
  ...
  themeConfig: {
    ...
    socialLinks: [
      {
        icon: 'github',
        link: 'https://github.com/linjialiang/zyrmjc.git',
      },
      {
        icon: {
        ...
        link: 'https://gitee.com/linjialiang/zyrmjc.git',
      },
    ],
    editLink: {
      pattern: 'https://gitee.com/linjialiang/zyrmjc/blob/main/:path',
      text: '在 gitee 上编辑',
    },
    outline: 'deep',
    i18nRouting: true,
