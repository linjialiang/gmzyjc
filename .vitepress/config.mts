...
export default withPwa(
  defineConfig({
    ...
    pwa: {
      base: '/',
      scope: '/',
      includeAssets: ['static/favicon.png', 'static/logo.png', 'static/wechat-pay.png'], // 告诉插件，这些静态资源要缓存起来
      ...
      workbox: {
        ...
        maximumFileSizeToCacheInBytes: 1000 * 1024 * 1024, // 单个文件最大1000MB，再大就不缓存了
      ...
      manifest: {
        name: '光明中医电子教材', // 完整名
        short_name: '光明教材', // 桌面图标下面显示的短名，太长显示不全
        description: '学习光明中医电子教材',
